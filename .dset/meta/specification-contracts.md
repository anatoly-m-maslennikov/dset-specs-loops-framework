...
- Independently selected implementation-language and artifact-governance profiles, including the `documentation-v1` registry under `.dset/project/artifacts.toml`.
- Accepted package truth in layer-owned fragments under `dset/<layer>/specs/`.
- Bounded, PR-traceable Changes under `dset/<primary-layer>/changes/`.
