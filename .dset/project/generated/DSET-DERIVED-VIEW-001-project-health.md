...
- **Source digest:** `46b246d55f2cf9049ee0ba21d0eb6c329f1292d1447b991e9e319b171350b608`
...
- **Decision authority linked from implementation commits:** `DSET-DECISION-OPS-009`, `DSET-DECISION-OPS-011`, `DSET-DECISION-SKILL-003`, `DSET-INVARIANT-GOV-027`, `DSET-REQUIREMENT-GOV-040`, `DSET-REQUIREMENT-GOV-042`
...
- **QA definitions connected to current evidence:** `DSET-EVALUATION-GOV-026`, `DSET-EVALUATION-GOV-028`, `DSET-EVALUATION-GOV-029`, `DSET-EVALUATION-GOV-031`, `DSET-EVALUATION-SKILL-012`, `DSET-EVALUATION-TOOL-003`, `DSET-EVALUATION-TOOL-004`, `DSET-TEST-GOV-045`, `DSET-TEST-GOV-047`, `DSET-TEST-OPS-018`, `DSET-TEST-OPS-019`, `DSET-TEST-OPS-020`, `DSET-TEST-SKILL-014`, `DSET-TEST-TOOL-021`, `DSET-TEST-TOOL-022`

## Artifact inventory

- **Governed artifacts:** 606
- **By role:** atomic=131, derived_or_navigation=75, evergreen=170, implementation=172, transactional=58
- **By type:** analysis_report=23, atomic_record=131, derived_view=1, evidence_record=46, implementation=172, navigation=43, plan=44, procedure=31, specification=86, verification=8, version=21
- **By subtype:** architecture=4, behavior=6, change=9, configuration=79, design=6, domain_model=1, evaluation_plan=14, evaluation_result=6, external_audit_analysis=2, governance=69, health_dashboard=1, hub=43, implementation_plan=10, migration=3, playbook=28, proposal=8, readiness_record=2, release_plan=2, release_record=1, review_report=2, roadmap=2, root_cause_analysis=1, run_record=9, runbook=3, solution_landscape=6, source_code=43, technical_investigation=2, test_implementation=47, test_plan=14, test_result=29, version_scope=5
- **By layer:** gov=148, meta=34, ops=46, repository=137, skill=87, tool=154
- **By effective priority:** critical=44, high=48, medium=508, unknown=6
...
- **Forward relations:** 474
- **By type:** analysis_of=1, check_of=38, child_of=56, evidence_for=23, implementation_of=297, projection_of=6, relates_to=19, replacement_of=24, resolution_of=10
- **By origin:** authored=146, commit_trailer=297, legacy_child_of=31
- **By source kind:** artifact=177, commit=297
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=455, skills=36, tests=46, toolchain=44
