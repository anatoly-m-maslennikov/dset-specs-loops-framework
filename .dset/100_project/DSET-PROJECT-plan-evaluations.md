...
|---|---|
| `plan-evaluations.md` | `DSET-EVAL-META-008..009` |
| `plan-evaluations.md` | `DSET-EVAL-GOV-007..022`, `DSET-EVAL-GOV-025`, `DSET-EVALUATION-GOV-026`, `DSET-EVALUATION-GOV-028..029`, `DSET-EVALUATION-GOV-032..034` |
| `plan-evaluations.md` | `DSET-EVALUATION-TOOL-003..004` |
| `plan-evaluations.md` | `DSET-EVAL-SKILL-002..008`, `DSET-EVAL-SKILL-010..011` |
| `plan-evaluations.md` | `DSET-EVAL-OPS-002..003`, `DSET-EVAL-OPS-010` |
