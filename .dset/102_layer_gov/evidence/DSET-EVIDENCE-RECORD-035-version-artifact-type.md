...
context = ["repository=anatoly-m-maslennikov/dset-specs-loops-framework", "environment=local-macos", "python=3.14", "artifact_type=version", "version_subtypes=6", "active_version_ids=7"]
observed_at = "2026-07-21T05:50:23+04:00"
evidence_location = "dset/scopes/skill/changes/make-dset-self-hosting-and-skills-thin/proofs/DSET-EVIDENCE-RECORD-035-version-artifact-type.md"
polarity = "supports"
currentness = "current"
