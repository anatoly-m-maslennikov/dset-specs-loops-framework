...
artifact_id: "DSET-REQUIREMENT-GOV-048"
scope_path:
  - "layer:gov"
priority: "high"
llm_session_ids:
...
Semantic compilation of atomic artifacts into evergreen specifications and plans is demand-driven and need not run after every new atomic artifact.
