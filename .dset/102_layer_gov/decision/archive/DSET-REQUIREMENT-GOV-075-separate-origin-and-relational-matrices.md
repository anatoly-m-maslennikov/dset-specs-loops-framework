...
artifact_id: "DSET-REQUIREMENT-GOV-075"
scope_path:
  - "layer:gov"
priority: "high"
promotion:
...
DSET presents artifact type, content role, and internal or external authority origin in the primary classification matrix, and presents relational or between-subject semantics only in a separate relation-shape matrix.

## Rationale

Authority origin and relational shape are orthogonal: a Contract or Conflict may relate several subjects while its governing artifact still has an internal or external origin.
