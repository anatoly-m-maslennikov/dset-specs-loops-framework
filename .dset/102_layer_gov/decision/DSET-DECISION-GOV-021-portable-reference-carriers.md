...
When recursive project truth is exactly the distributable framework truth, DSET records a repository-relative TOML reference carrier instead of duplicating bytes or relying on filesystem symlinks.
