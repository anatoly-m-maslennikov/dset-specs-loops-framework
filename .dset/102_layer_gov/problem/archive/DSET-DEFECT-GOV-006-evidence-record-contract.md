...
artifact_id: "DSET-DEFECT-GOV-006"
scope_path:
  - "layer:gov"
priority: "high"
llm_session_ids:
...
Promoted Evidence Records are immutable but lack an executable schema for their required subject, producer, method, context, time, polarity, currentness, and reopen boundary.

## Rationale

Evidence cannot support a bounded claim reliably when its because-graph exists only as optional prose.
