...
3. Run the selected entrypoint with `rules resolve landscape --format json`; stop on a nonzero result without fallback to the wrapper, memory, installed templates, or remote framework prose.
