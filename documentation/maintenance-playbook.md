...
2. Identify the one current owner and classify the requested content by artifact type.
...
7. Update the parent hub only when the stable navigation route changes; do not add every leaf file.
