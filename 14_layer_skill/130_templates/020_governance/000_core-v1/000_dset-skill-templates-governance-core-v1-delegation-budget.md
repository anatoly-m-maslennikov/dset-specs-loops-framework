...
the selected project profile. `.dset/dset_settings.toml` selects
`delegation.budget_profile`; `.dset/000_dset_methodology/04_skill/budget.toml` defines the named
