...
criteria, thresholds, and expected disposition. Later semantic change requires
a successor atom. Storage state is only active or archived.
...
old aliases from accepted lookup after cutover. A claim, rationale, authority,
provenance fact, scope meaning, relation meaning, or QA-criterion change
requires a successor atom. Aggregate mutable transition ledgers and unproved
...
replacement predecessors, and invalid recurrence Types. Conflict resolution classifies role
