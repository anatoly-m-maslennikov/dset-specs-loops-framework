...
The cross-cutting documentation architecture owns artifact types, authoring rules, hubs, maintenance, rationale, and applied artifact profiles. It is independent from the numbered implementation pipeline and is not a sixth stage or an implementation language.
