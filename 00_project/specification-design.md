...
in [contracts.md](specification-contracts.md). They state observable compatibility and
...
- **DSET-QUESTION-GOV-001 — First-class Action entity** in [`00_project/intake.toml`](intake.toml):
...
- Six additional open Questions in [`00_project/intake.toml`](intake.toml) defer
