...
*Provenance: the language-neutral categories are distilled from repeated tool refactors and best-practice adoption work; Python v1 carries forward the existing Python enforcement profile; pattern canon lives in `04_General Build Rules — Tool Code Conventions.md`, and external grounding lives in `06_External Grounding — LLM Power-User Practice.md`.*
