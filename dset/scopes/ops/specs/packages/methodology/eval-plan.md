...
| **DSET-EVAL-OPS-010** | Release artifact boundaries | Every reviewer assigns scope, sequencing, exact transition, gate disposition, and publication history to Version Scope, Roadmap, Release Plan, Readiness Record, and Release Record respectively; treats milestones as Roadmap entries; and never promotes Verification, green checks, rendered notes, or workflow position into a release authority |
