...
| Primary orchestrator plus clarify/diagnose/prototype/release specialists/current implementation | Repository/project license | One-skill and per-step alternatives / discovery, ownership, stop boundaries | [Skill-surface specification](specs/methodology.md#added--dset-requirement-skill-004-public-skills-remain-small-and-purposeful); five wrappers and internal workflows implemented; host integration incomplete | degraded | Favorable on specified topology; runtime comparison pending | Small discovery surface; CLI/host bridge, publisher, and host distribution remain |
