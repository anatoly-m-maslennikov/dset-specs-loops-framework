...
- **Source digest:** `70ae4f2a7af822a737ee121c72b1e939734ffa892d367d7f908f2daf6c19a7a8`
...
|---|---:|---:|---:|---:|---:|---:|
| Decision authority compiled into evergreen truth | 94 | 94 | 0 | 0 | 0 | 0 |
| Decision authority linked from implementation commits | 17 | 21 | 73 | 0 | 4 | 0 |
| Applicable authority connected to Test or Evaluation | 15 | 94 | 0 | 0 | 79 | 0 |
| QA definitions connected to current evidence | 13 | 130 | 0 | 0 | 117 | 0 |
...
- **QA definitions connected to current evidence:** `DSET-EVAL-GOV-001`, `DSET-EVAL-GOV-002`, `DSET-EVAL-GOV-003`, `DSET-EVAL-GOV-004`, `DSET-EVAL-GOV-005`, `DSET-EVAL-GOV-006`, `DSET-EVAL-GOV-007`, `DSET-EVAL-GOV-008`, `DSET-EVAL-GOV-009`, `DSET-EVAL-GOV-010`, `DSET-EVAL-GOV-011`, `DSET-EVAL-GOV-012`, `DSET-EVAL-GOV-013`, `DSET-EVAL-GOV-014`, `DSET-EVAL-GOV-016`, `DSET-EVAL-GOV-017`, `DSET-EVAL-GOV-018`, `DSET-EVAL-GOV-020`, `DSET-EVAL-GOV-021`, `DSET-EVAL-GOV-022`, `DSET-EVAL-GOV-023`, `DSET-EVAL-META-001`, `DSET-EVAL-META-002`, `DSET-EVAL-META-003`, `DSET-EVAL-META-004`, `DSET-EVAL-META-005`, `DSET-EVAL-META-006`, `DSET-EVAL-META-007`, `DSET-EVAL-META-008`, `DSET-EVAL-META-009`, `DSET-EVAL-OPS-001`, `DSET-EVAL-OPS-002`, `DSET-EVAL-OPS-003`, `DSET-EVAL-SKILL-001`, `DSET-EVAL-SKILL-002`, `DSET-EVAL-SKILL-003`, `DSET-EVAL-SKILL-004`, `DSET-EVAL-SKILL-005`, `DSET-EVAL-SKILL-006`, `DSET-EVAL-SKILL-007`, `DSET-EVAL-SKILL-008`, `DSET-EVAL-TOOL-001`, `DSET-EVALUATION-GOV-026`, `DSET-EVALUATION-GOV-028`, `DSET-EVALUATION-GOV-029`, `DSET-EVALUATION-SKILL-012`, `DSET-EVALUATION-TOOL-003`, `DSET-EVALUATION-TOOL-004`, `DSET-TEST-GOV-001`, `DSET-TEST-GOV-002`, `DSET-TEST-GOV-003`, `DSET-TEST-GOV-004`, `DSET-TEST-GOV-005`, `DSET-TEST-GOV-006`, `DSET-TEST-GOV-007`, `DSET-TEST-GOV-008`, `DSET-TEST-GOV-009`, `DSET-TEST-GOV-010`, `DSET-TEST-GOV-011`, `DSET-TEST-GOV-012`, `DSET-TEST-GOV-013`, `DSET-TEST-GOV-014`, `DSET-TEST-GOV-015`, `DSET-TEST-GOV-016`, `DSET-TEST-GOV-017`, `DSET-TEST-GOV-018`, `DSET-TEST-GOV-019`, `DSET-TEST-GOV-020`, `DSET-TEST-GOV-021`, `DSET-TEST-GOV-022`, `DSET-TEST-GOV-023`, `DSET-TEST-GOV-024`, `DSET-TEST-GOV-025`, `DSET-TEST-GOV-026`, `DSET-TEST-GOV-027`, `DSET-TEST-GOV-028`, `DSET-TEST-GOV-030`, `DSET-TEST-GOV-031`, `DSET-TEST-GOV-032`, `DSET-TEST-GOV-033`, `DSET-TEST-GOV-045`, `DSET-TEST-META-001`, `DSET-TEST-META-002`, `DSET-TEST-META-003`, `DSET-TEST-META-004`, `DSET-TEST-META-005`, `DSET-TEST-META-006`, `DSET-TEST-META-007`, `DSET-TEST-META-008`, `DSET-TEST-META-009`, `DSET-TEST-META-010`, `DSET-TEST-OPS-001`, `DSET-TEST-OPS-002`, `DSET-TEST-OPS-003`, `DSET-TEST-OPS-004`, `DSET-TEST-OPS-006`, `DSET-TEST-OPS-007`, `DSET-TEST-OPS-018`, `DSET-TEST-SKILL-001`, `DSET-TEST-SKILL-002`, `DSET-TEST-SKILL-003`, `DSET-TEST-SKILL-005`, `DSET-TEST-SKILL-006`, `DSET-TEST-SKILL-007`, `DSET-TEST-SKILL-008`, `DSET-TEST-SKILL-009`, `DSET-TEST-SKILL-010`, `DSET-TEST-SKILL-014`, `DSET-TEST-TOOL-001`, `DSET-TEST-TOOL-002`, `DSET-TEST-TOOL-003`, `DSET-TEST-TOOL-004`, `DSET-TEST-TOOL-005`, `DSET-TEST-TOOL-018`, `DSET-TEST-TOOL-019`, `DSET-TEST-TOOL-021`, `DSET-TEST-TOOL-022`

## Artifact inventory

- **Governed artifacts:** 595
- **By role:** atomic=117, derived_or_navigation=84, evergreen=169, implementation=169, transactional=56
- **By type:** analysis_report=23, atomic_record=117, derived_view=1, evidence_record=44, implementation=169, navigation=52, plan=43, procedure=22, specification=95, verification=8, version=21
- **By subtype:** architecture=7, behavior=29, change=9, configuration=79, design=7, domain_model=6, evaluation_plan=14, evaluation_result=5, external_audit_analysis=2, governance=46, health_dashboard=1, hub=52, implementation_plan=9, migration=3, playbook=19, proposal=8, readiness_record=2, release_plan=2, release_record=1, review_report=2, roadmap=2, root_cause_analysis=1, run_record=9, runbook=3, solution_landscape=7, source_code=43, technical_investigation=3, test_implementation=44, test_plan=14, test_result=28, version_scope=5
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=235, tool=141
- **By effective priority:** critical=31, high=48, medium=510, unknown=6
- **By status:** absorbed=22, accepted=45, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 317
- **By Type:** decision=120, problem=41, qa=137, question=19
- **By direct subtype:** conflict=1, contract=6, defect=21, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=86
- **Native immutable atoms:** 91
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 446
- **By type:** analysis_of=1, check_of=28, child_of=49, evidence_for=21, implementation_of=294, projection_of=6, relates_to=19, replacement_of=21, resolution_of=7
- **By origin:** authored=121, commit_trailer=294, legacy_child_of=31
- **By source kind:** artifact=152, commit=294
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=491, skills=36, tests=43, toolchain=44
