...
- **Source digest:** `5706c321a699fdd66d2f838ce944a31eae4f55ab4d6fc20b5e9ed1fc3c31bab7`
...
- **Governed artifacts:** 354
- **By role:** atomic=38, derived_or_navigation=85, evergreen=88, implementation=116, transactional=27
- **By type:** analysis_report=21, atomic_record=38, change=9, derived_view=1, evidence_record=18, implementation=116, navigation=52, plan=40, readiness_record=2, release_record=1, specification=48, verification=8
- **By subtype:** architecture=5, behavior=10, configuration=10, design=7, documentation=33, domain_model=6, evaluation_plan=14, evaluation_result=2, external_audit_analysis=1, governance=15, health_dashboard=1, hub=52, implementation_plan=7, proposal=8, release_plan=2, review_report=1, roadmap=2, root_cause_analysis=1, run_record=9, solution_landscape=7, source_code=35, technical_investigation=3, test_implementation=38, test_plan=14, test_result=6, version_scope=5
- **By layer:** gov=68, meta=24, ops=33, repository=4, skill=113, tool=112
- **By effective priority:** critical=1, high=12, medium=335, unknown=6
...
- **Work Areas:** delivery=0, documentation=1, methodology=1, project-control=279, skills=34, tests=38, toolchain=35
