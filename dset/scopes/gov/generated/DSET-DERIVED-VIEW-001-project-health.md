...
- **Source digest:** `78b301b2a4bb6271da4034d6b3bfc08c02031d0409a5ec7251cbe05fabe1ccfd`
...
| Decision authority linked from implementation commits | 18 | 22 | 73 | 0 | 4 | 0 |
...
- **Decision authority linked from implementation commits:** `DSET-DECISION-OPS-009`, `DSET-DECISION-SKILL-003`, `DSET-INVARIANT-GOV-027`, `DSET-REQUIREMENT-GOV-040`
...
- **Forward relations:** 454
- **By type:** analysis_of=1, check_of=30, child_of=51, evidence_for=22, implementation_of=296, projection_of=6, relates_to=19, replacement_of=21, resolution_of=8
- **By origin:** authored=127, commit_trailer=296, legacy_child_of=31
- **By source kind:** artifact=158, commit=296
