...
- **Source digest:** `ff85fc8f7976a690d9ecd9ca8614b9c5a8e858900830b5e64f43245627c08f58`
...
| Decision authority linked from implementation commits | 14 | 17 | 74 | 0 | 3 | 0 |
...
- **Decision authority linked from implementation commits:** `DSET-DECISION-GOV-018`, `DSET-INVARIANT-GOV-027`, `DSET-REQUIREMENT-GOV-040`
...
- **Governed artifacts:** 557
- **By role:** atomic=102, derived_or_navigation=84, evergreen=164, implementation=162, transactional=45
- **By type:** analysis_report=23, atomic_record=102, delivery=21, derived_view=1, evidence_record=33, implementation=162, navigation=52, plan=39, procedure=21, specification=95, verification=8
...
- **By layer:** gov=108, meta=36, ops=44, repository=27, skill=203, tool=139
- **By effective priority:** critical=22, high=43, medium=486, unknown=6
...
- **Forward relations:** 385
- **By type:** analysis_of=1, check_of=18, child_of=43, evidence_for=9, implementation_of=271, projection_of=3, relates_to=18, replacement_of=18, resolution_of=4
- **By origin:** authored=83, commit_trailer=271, legacy_child_of=31
- **By source kind:** artifact=114, commit=271
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=456, skills=34, tests=42, toolchain=43
