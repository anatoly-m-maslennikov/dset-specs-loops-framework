...
- **Source digest:** `c93cbc13d5d480d4b32bedfd88125dff2f1098a22fd7fcc260219682211f95bf`
...
|---|---:|---:|---:|---:|---:|---:|
| Decision authority compiled into evergreen truth | 96 | 96 | 0 | 0 | 0 | 0 |
| Decision authority linked from implementation commits | 18 | 23 | 73 | 0 | 5 | 0 |
| Applicable authority connected to Test or Evaluation | 17 | 96 | 0 | 0 | 79 | 0 |
| QA definitions connected to current evidence | 13 | 132 | 0 | 0 | 119 | 0 |
...
- **Governed artifacts:** 603
- **By role:** atomic=123, derived_or_navigation=84, evergreen=169, implementation=170, transactional=57
- **By type:** analysis_report=23, atomic_record=123, derived_view=1, evidence_record=45, implementation=170, navigation=52, plan=43, procedure=22, specification=95, verification=8, version=21
...
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=242, tool=142
- **By effective priority:** critical=37, high=48, medium=512, unknown=6
- **By status:** absorbed=22, accepted=51, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 323
- **By Type:** decision=122, problem=43, qa=139, question=19
- **By direct subtype:** conflict=1, contract=6, defect=23, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=88
- **Native immutable atoms:** 97
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 459
- **By type:** analysis_of=1, check_of=32, child_of=53, evidence_for=22, implementation_of=296, projection_of=6, relates_to=19, replacement_of=21, resolution_of=9
- **By origin:** authored=132, commit_trailer=296, legacy_child_of=31
- **By source kind:** artifact=163, commit=296
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=498, skills=36, tests=44, toolchain=44
