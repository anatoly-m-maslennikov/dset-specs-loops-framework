...
- **Source digest:** `f85072b07d0de21428a642c74fb65e1af69e1edea0ce76f613bc075cab7b9a20`
...
|---|---:|---:|---:|---:|---:|---:|
| Decision authority compiled into evergreen truth | 93 | 93 | 0 | 0 | 0 | 0 |
| Decision authority linked from implementation commits | 17 | 20 | 73 | 0 | 3 | 0 |
| Applicable authority connected to Test or Evaluation | 14 | 93 | 0 | 0 | 79 | 0 |
| QA definitions connected to current evidence | 13 | 129 | 0 | 0 | 116 | 0 |

### Coverage gaps

- **Decision authority compiled into evergreen truth:** none
- **Decision authority linked from implementation commits:** `DSET-DECISION-SKILL-003`, `DSET-INVARIANT-GOV-027`, `DSET-REQUIREMENT-GOV-040`
...
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=231, tool=141
- **By effective priority:** critical=28, high=48, medium=509, unknown=6
- **By status:** absorbed=22, accepted=42, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 314
- **By Type:** decision=119, problem=40, qa=136, question=19
- **By direct subtype:** conflict=1, contract=6, defect=20, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=85
- **Native immutable atoms:** 88
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 441
- **By type:** analysis_of=1, check_of=26, child_of=47, evidence_for=21, implementation_of=294, projection_of=6, relates_to=19, replacement_of=21, resolution_of=6
- **By origin:** authored=116, commit_trailer=294, legacy_child_of=31
- **By source kind:** artifact=147, commit=294
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=487, skills=36, tests=43, toolchain=44
