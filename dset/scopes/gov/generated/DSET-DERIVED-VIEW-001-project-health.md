...
- **Source digest:** `377f6ad97d4af7835a71543b7c254bb3b878e4c65bcf6ae556360039f2f8f757`
...
| QA definitions connected to current evidence | 58 | 130 | 0 | 0 | 71 | 1 |
...
- **Governed artifacts:** 404
- **By role:** atomic=69, derived_or_navigation=103, evergreen=81, implementation=125, transactional=26
- **By type:** analysis_report=21, atomic_record=69, delivery=21, derived_view=1, evidence_record=26, implementation=125, navigation=52, plan=37, specification=44, verification=8
- **By subtype:** architecture=5, behavior=10, change=9, configuration=10, design=7, documentation=33, domain_model=6, evaluation_plan=14, evaluation_result=2, external_audit_analysis=1, governance=16, health_dashboard=1, hub=52, implementation_plan=7, proposal=8, readiness_record=2, release_plan=2, release_record=1, review_report=2, roadmap=2, root_cause_analysis=1, run_record=9, solution_landscape=7, source_code=41, technical_investigation=3, test_implementation=41, test_plan=14, test_result=13, version_scope=5
- **By layer:** gov=69, meta=24, ops=33, repository=4, skill=153, tool=121
- **By effective priority:** critical=7, high=32, medium=359, unknown=6
...
- **Forward relations:** 282
- **By type:** check_of=8, child_of=33, evidence_for=3, implementation_of=221, projection_of=3, relates_to=5, replacement_of=8, resolution_of=1
- **By origin:** authored=30, commit_trailer=221, legacy_child_of=31
- **By source kind:** artifact=61, commit=221
...
- **Work Areas:** delivery=0, documentation=1, methodology=1, project-control=326, skills=34, tests=41, toolchain=41
