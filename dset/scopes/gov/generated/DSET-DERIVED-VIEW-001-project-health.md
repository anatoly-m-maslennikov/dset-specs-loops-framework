...
- **Source digest:** `d4cc2778563beed427ab5f2455815de61ca9f68630ba9ed7a05304eccf095e8d`
...
| QA definitions connected to current evidence | 7 | 129 | 0 | 0 | 122 | 0 |
...
- **QA definitions connected to current evidence:** `DSET-EVAL-GOV-001`, `DSET-EVAL-GOV-002`, `DSET-EVAL-GOV-003`, `DSET-EVAL-GOV-004`, `DSET-EVAL-GOV-005`, `DSET-EVAL-GOV-006`, `DSET-EVAL-GOV-007`, `DSET-EVAL-GOV-008`, `DSET-EVAL-GOV-009`, `DSET-EVAL-GOV-010`, `DSET-EVAL-GOV-011`, `DSET-EVAL-GOV-012`, `DSET-EVAL-GOV-013`, `DSET-EVAL-GOV-014`, `DSET-EVAL-GOV-015`, `DSET-EVAL-GOV-016`, `DSET-EVAL-GOV-017`, `DSET-EVAL-GOV-018`, `DSET-EVAL-GOV-019`, `DSET-EVAL-GOV-020`, `DSET-EVAL-GOV-021`, `DSET-EVAL-GOV-022`, `DSET-EVAL-GOV-023`, `DSET-EVAL-META-001`, `DSET-EVAL-META-002`, `DSET-EVAL-META-003`, `DSET-EVAL-META-004`, `DSET-EVAL-META-005`, `DSET-EVAL-META-006`, `DSET-EVAL-META-007`, `DSET-EVAL-META-008`, `DSET-EVAL-META-009`, `DSET-EVAL-OPS-001`, `DSET-EVAL-OPS-002`, `DSET-EVAL-OPS-003`, `DSET-EVAL-OPS-010`, `DSET-EVAL-SKILL-001`, `DSET-EVAL-SKILL-002`, `DSET-EVAL-SKILL-003`, `DSET-EVAL-SKILL-004`, `DSET-EVAL-SKILL-005`, `DSET-EVAL-SKILL-006`, `DSET-EVAL-SKILL-007`, `DSET-EVAL-SKILL-008`, `DSET-EVAL-TOOL-001`, `DSET-EVALUATION-GOV-026`, `DSET-EVALUATION-GOV-028`, `DSET-EVALUATION-SKILL-012`, `DSET-EVALUATION-TOOL-003`, `DSET-EVALUATION-TOOL-004`, `DSET-TEST-GOV-001`, `DSET-TEST-GOV-002`, `DSET-TEST-GOV-003`, `DSET-TEST-GOV-004`, `DSET-TEST-GOV-005`, `DSET-TEST-GOV-006`, `DSET-TEST-GOV-007`, `DSET-TEST-GOV-008`, `DSET-TEST-GOV-009`, `DSET-TEST-GOV-010`, `DSET-TEST-GOV-011`, `DSET-TEST-GOV-012`, `DSET-TEST-GOV-013`, `DSET-TEST-GOV-014`, `DSET-TEST-GOV-015`, `DSET-TEST-GOV-016`, `DSET-TEST-GOV-017`, `DSET-TEST-GOV-018`, `DSET-TEST-GOV-019`, `DSET-TEST-GOV-020`, `DSET-TEST-GOV-021`, `DSET-TEST-GOV-022`, `DSET-TEST-GOV-023`, `DSET-TEST-GOV-024`, `DSET-TEST-GOV-025`, `DSET-TEST-GOV-026`, `DSET-TEST-GOV-027`, `DSET-TEST-GOV-028`, `DSET-TEST-GOV-029`, `DSET-TEST-GOV-030`, `DSET-TEST-GOV-031`, `DSET-TEST-GOV-032`, `DSET-TEST-GOV-033`, `DSET-TEST-META-001`, `DSET-TEST-META-002`, `DSET-TEST-META-003`, `DSET-TEST-META-004`, `DSET-TEST-META-005`, `DSET-TEST-META-006`, `DSET-TEST-META-007`, `DSET-TEST-META-008`, `DSET-TEST-META-009`, `DSET-TEST-META-010`, `DSET-TEST-META-011`, `DSET-TEST-OPS-001`, `DSET-TEST-OPS-002`, `DSET-TEST-OPS-003`, `DSET-TEST-OPS-004`, `DSET-TEST-OPS-005`, `DSET-TEST-OPS-006`, `DSET-TEST-OPS-007`, `DSET-TEST-OPS-016`, `DSET-TEST-SKILL-001`, `DSET-TEST-SKILL-002`, `DSET-TEST-SKILL-003`, `DSET-TEST-SKILL-004`, `DSET-TEST-SKILL-005`, `DSET-TEST-SKILL-006`, `DSET-TEST-SKILL-007`, `DSET-TEST-SKILL-008`, `DSET-TEST-SKILL-009`, `DSET-TEST-SKILL-010`, `DSET-TEST-SKILL-014`, `DSET-TEST-TOOL-001`, `DSET-TEST-TOOL-002`, `DSET-TEST-TOOL-003`, `DSET-TEST-TOOL-004`, `DSET-TEST-TOOL-005`, `DSET-TEST-TOOL-018`, `DSET-TEST-TOOL-019`, `DSET-TEST-TOOL-021`, `DSET-TEST-TOOL-022`

## Artifact inventory

- **Governed artifacts:** 565
- **By role:** atomic=102, derived_or_navigation=84, evergreen=164, implementation=168, transactional=47
- **By type:** analysis_report=23, atomic_record=102, delivery=21, derived_view=1, evidence_record=35, implementation=168, navigation=52, plan=39, procedure=21, specification=95, verification=8
- **By subtype:** architecture=7, behavior=29, change=9, configuration=78, design=7, domain_model=6, evaluation_plan=14, evaluation_result=2, external_audit_analysis=2, governance=46, health_dashboard=1, hub=52, implementation_plan=9, migration=3, playbook=18, proposal=8, readiness_record=2, release_plan=2, release_record=1, review_report=2, roadmap=2, root_cause_analysis=1, run_record=9, runbook=3, solution_landscape=7, source_code=43, technical_investigation=3, test_implementation=44, test_plan=14, test_result=22, version_scope=5
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=205, tool=141
- **By effective priority:** critical=22, high=43, medium=494, unknown=6
- **By status:** absorbed=20, accepted=32, open=20, resolved=38

## Semantic inventory

- **Semantic claims:** 307
- **By Type:** decision=114, problem=38, qa=136, question=19
- **By direct subtype:** conflict=1, contract=6, defect=18, evaluation=52, gap=4, invariant=1, opportunity=3, requirement=81, test=84
- **Native immutable atoms:** 76
- **Compatibility-classified legacy IDs:** 231

## Typed relation inventory

- **Forward relations:** 393
- **By type:** analysis_of=1, check_of=18, child_of=43, evidence_for=11, implementation_of=277, projection_of=3, relates_to=18, replacement_of=18, resolution_of=4
- **By origin:** authored=85, commit_trailer=277, legacy_child_of=31
- **By source kind:** artifact=116, commit=277
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=463, skills=34, tests=43, toolchain=44
