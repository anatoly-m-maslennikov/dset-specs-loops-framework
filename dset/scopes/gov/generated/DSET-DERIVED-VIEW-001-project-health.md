...
- **Source digest:** `5a1cce4f9cf7d9388bf14e4ed74a6d5f22a04eaf125624bb42c64a3dab69016b`
...
| Decision authority linked from implementation commits | 17 | 19 | 73 | 0 | 2 | 0 |
| Applicable authority connected to Test or Evaluation | 13 | 92 | 0 | 0 | 79 | 0 |
| QA definitions connected to current evidence | 11 | 128 | 0 | 0 | 117 | 0 |
...
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=225, tool=141
- **By effective priority:** critical=25, high=48, medium=506, unknown=6
- **By status:** absorbed=22, accepted=39, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 311
- **By Type:** decision=118, problem=39, qa=135, question=19
- **By direct subtype:** conflict=1, contract=6, defect=19, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=84
- **Native immutable atoms:** 85
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 432
- **By type:** analysis_of=1, check_of=25, child_of=45, evidence_for=19, implementation_of=291, projection_of=6, relates_to=19, replacement_of=21, resolution_of=5
- **By origin:** authored=110, commit_trailer=291, legacy_child_of=31
- **By source kind:** artifact=141, commit=291
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=481, skills=36, tests=43, toolchain=44
