...
- **Source digest:** `8f3e1f9f2a6fe156923257675c5dae6ec117717fd12f32b55f48f9b2b1f88df0`
...
|---|---:|---:|---:|---:|---:|---:|
| Decision authority compiled into evergreen truth | 95 | 95 | 0 | 0 | 0 | 0 |
| Decision authority linked from implementation commits | 17 | 22 | 73 | 0 | 5 | 0 |
| Applicable authority connected to Test or Evaluation | 16 | 95 | 0 | 0 | 79 | 0 |
| QA definitions connected to current evidence | 13 | 131 | 0 | 0 | 118 | 0 |

### Coverage gaps

- **Decision authority compiled into evergreen truth:** none
- **Decision authority linked from implementation commits:** `DSET-DECISION-OPS-009`, `DSET-DECISION-OPS-010`, `DSET-DECISION-SKILL-003`, `DSET-INVARIANT-GOV-027`, `DSET-REQUIREMENT-GOV-040`
...
- **QA definitions connected to current evidence:** `DSET-EVAL-GOV-001`, `DSET-EVAL-GOV-002`, `DSET-EVAL-GOV-003`, `DSET-EVAL-GOV-004`, `DSET-EVAL-GOV-005`, `DSET-EVAL-GOV-006`, `DSET-EVAL-GOV-007`, `DSET-EVAL-GOV-008`, `DSET-EVAL-GOV-009`, `DSET-EVAL-GOV-010`, `DSET-EVAL-GOV-011`, `DSET-EVAL-GOV-012`, `DSET-EVAL-GOV-013`, `DSET-EVAL-GOV-014`, `DSET-EVAL-GOV-016`, `DSET-EVAL-GOV-017`, `DSET-EVAL-GOV-018`, `DSET-EVAL-GOV-020`, `DSET-EVAL-GOV-021`, `DSET-EVAL-GOV-022`, `DSET-EVAL-GOV-023`, `DSET-EVAL-META-001`, `DSET-EVAL-META-002`, `DSET-EVAL-META-003`, `DSET-EVAL-META-004`, `DSET-EVAL-META-005`, `DSET-EVAL-META-006`, `DSET-EVAL-META-007`, `DSET-EVAL-META-008`, `DSET-EVAL-META-009`, `DSET-EVAL-OPS-001`, `DSET-EVAL-OPS-002`, `DSET-EVAL-OPS-003`, `DSET-EVAL-SKILL-001`, `DSET-EVAL-SKILL-002`, `DSET-EVAL-SKILL-003`, `DSET-EVAL-SKILL-004`, `DSET-EVAL-SKILL-005`, `DSET-EVAL-SKILL-006`, `DSET-EVAL-SKILL-007`, `DSET-EVAL-SKILL-008`, `DSET-EVAL-TOOL-001`, `DSET-EVALUATION-GOV-026`, `DSET-EVALUATION-GOV-028`, `DSET-EVALUATION-GOV-029`, `DSET-EVALUATION-SKILL-012`, `DSET-EVALUATION-TOOL-003`, `DSET-EVALUATION-TOOL-004`, `DSET-TEST-GOV-001`, `DSET-TEST-GOV-002`, `DSET-TEST-GOV-003`, `DSET-TEST-GOV-004`, `DSET-TEST-GOV-005`, `DSET-TEST-GOV-006`, `DSET-TEST-GOV-007`, `DSET-TEST-GOV-008`, `DSET-TEST-GOV-009`, `DSET-TEST-GOV-010`, `DSET-TEST-GOV-011`, `DSET-TEST-GOV-012`, `DSET-TEST-GOV-013`, `DSET-TEST-GOV-014`, `DSET-TEST-GOV-015`, `DSET-TEST-GOV-016`, `DSET-TEST-GOV-017`, `DSET-TEST-GOV-018`, `DSET-TEST-GOV-019`, `DSET-TEST-GOV-020`, `DSET-TEST-GOV-021`, `DSET-TEST-GOV-022`, `DSET-TEST-GOV-023`, `DSET-TEST-GOV-024`, `DSET-TEST-GOV-025`, `DSET-TEST-GOV-026`, `DSET-TEST-GOV-027`, `DSET-TEST-GOV-028`, `DSET-TEST-GOV-030`, `DSET-TEST-GOV-031`, `DSET-TEST-GOV-032`, `DSET-TEST-GOV-033`, `DSET-TEST-GOV-045`, `DSET-TEST-META-001`, `DSET-TEST-META-002`, `DSET-TEST-META-003`, `DSET-TEST-META-004`, `DSET-TEST-META-005`, `DSET-TEST-META-006`, `DSET-TEST-META-007`, `DSET-TEST-META-008`, `DSET-TEST-META-009`, `DSET-TEST-META-010`, `DSET-TEST-OPS-001`, `DSET-TEST-OPS-002`, `DSET-TEST-OPS-003`, `DSET-TEST-OPS-004`, `DSET-TEST-OPS-006`, `DSET-TEST-OPS-007`, `DSET-TEST-OPS-018`, `DSET-TEST-OPS-019`, `DSET-TEST-SKILL-001`, `DSET-TEST-SKILL-002`, `DSET-TEST-SKILL-003`, `DSET-TEST-SKILL-005`, `DSET-TEST-SKILL-006`, `DSET-TEST-SKILL-007`, `DSET-TEST-SKILL-008`, `DSET-TEST-SKILL-009`, `DSET-TEST-SKILL-010`, `DSET-TEST-SKILL-014`, `DSET-TEST-TOOL-001`, `DSET-TEST-TOOL-002`, `DSET-TEST-TOOL-003`, `DSET-TEST-TOOL-004`, `DSET-TEST-TOOL-005`, `DSET-TEST-TOOL-018`, `DSET-TEST-TOOL-019`, `DSET-TEST-TOOL-021`, `DSET-TEST-TOOL-022`

## Artifact inventory

- **Governed artifacts:** 600
- **By role:** atomic=120, derived_or_navigation=84, evergreen=169, implementation=170, transactional=57
- **By type:** analysis_report=23, atomic_record=120, derived_view=1, evidence_record=45, implementation=170, navigation=52, plan=43, procedure=22, specification=95, verification=8, version=21
- **By subtype:** architecture=7, behavior=29, change=9, configuration=79, design=7, domain_model=6, evaluation_plan=14, evaluation_result=6, external_audit_analysis=2, governance=46, health_dashboard=1, hub=52, implementation_plan=9, migration=3, playbook=19, proposal=8, readiness_record=2, release_plan=2, release_record=1, review_report=2, roadmap=2, root_cause_analysis=1, run_record=9, runbook=3, solution_landscape=7, source_code=43, technical_investigation=3, test_implementation=45, test_plan=14, test_result=28, version_scope=5
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=239, tool=142
- **By effective priority:** critical=34, high=48, medium=512, unknown=6
- **By status:** absorbed=22, accepted=48, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 320
- **By Type:** decision=121, problem=42, qa=138, question=19
- **By direct subtype:** conflict=1, contract=6, defect=22, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=87
- **Native immutable atoms:** 94
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 453
- **By type:** analysis_of=1, check_of=30, child_of=51, evidence_for=22, implementation_of=295, projection_of=6, relates_to=19, replacement_of=21, resolution_of=8
- **By origin:** authored=127, commit_trailer=295, legacy_child_of=31
- **By source kind:** artifact=158, commit=295
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=495, skills=36, tests=44, toolchain=44
