...
- **Governed artifacts:** 328
- **By role:** atomic=28, derived_or_navigation=84, evergreen=88, implementation=111, transactional=17
- **By type:** analysis_report=20, atomic_record=28, change=9, derived_view=1, evidence_record=8, implementation=111, navigation=52, plan=40, readiness_record=2, release_record=1, specification=48, verification=8
- **By subtype:** architecture=5, behavior=10, configuration=9, design=7, documentation=33, domain_model=6, evaluation_plan=14, external_audit_analysis=1, governance=15, health_dashboard=1, hub=52, implementation_plan=7, proposal=8, release_plan=2, review_report=1, roadmap=2, root_cause_analysis=1, run_record=7, solution_landscape=7, source_code=33, technical_investigation=2, test_implementation=36, test_plan=14, version_scope=5
- **By layer:** gov=68, meta=24, ops=33, repository=4, skill=92, tool=107
- **By effective priority:** critical=1, high=2, medium=319, unknown=6
- **By status:** accepted=9, archived=4, in-progress=1, open=24, resolved=9
...
- **Work Areas:** delivery=0, documentation=1, methodology=1, project-control=255, skills=34, tests=36, toolchain=33
