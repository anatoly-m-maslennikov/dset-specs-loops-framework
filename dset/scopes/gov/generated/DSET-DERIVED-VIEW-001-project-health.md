...
- **Source digest:** `8341a60ac72a23213edd24dc573c2407ab515ac544fc26daec7f658b72fd3deb`
...
- **Governed artifacts:** 397
- **By role:** atomic=65, derived_or_navigation=103, evergreen=81, implementation=123, transactional=25
- **By type:** analysis_report=21, atomic_record=65, delivery=21, derived_view=1, evidence_record=25, implementation=123, navigation=52, plan=37, specification=44, verification=8
...
- **By layer:** gov=69, meta=24, ops=33, repository=4, skill=148, tool=119
- **By effective priority:** critical=7, high=29, medium=355, unknown=6
- **By status:** absorbed=8, accepted=24, archived=4, in-progress=1, open=20, resolved=28

## Semantic inventory

- **Semantic claims:** 279
- **By Type:** decision=104, problem=29, qa=128, question=18
- **By direct subtype:** contract=6, defect=9, evaluation=52, gap=4, opportunity=3, requirement=76, test=76
- **Native immutable atoms:** 46
...
- **Work Areas:** delivery=0, documentation=1, methodology=1, project-control=319, skills=34, tests=41, toolchain=39
