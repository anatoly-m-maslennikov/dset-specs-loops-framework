...
- **Source digest:** `6fb86507a50c62ca79445ba650c3d920ffdeb5fb0d2f1e097b900f705a519365`
...
- **Governed artifacts:** 326
- **By role:** atomic=28, derived_or_navigation=84, evergreen=88, implementation=109, transactional=17
- **By type:** analysis_report=20, atomic_record=28, change=9, derived_view=1, evidence_record=8, implementation=109, navigation=52, plan=40, readiness_record=2, release_record=1, specification=48, verification=8
- **By subtype:** architecture=5, behavior=10, configuration=9, design=7, documentation=33, domain_model=6, evaluation_plan=14, external_audit_analysis=1, governance=15, health_dashboard=1, hub=52, implementation_plan=7, proposal=8, release_plan=2, review_report=1, roadmap=2, root_cause_analysis=1, run_record=7, solution_landscape=7, source_code=32, technical_investigation=2, test_implementation=35, test_plan=14, version_scope=5
- **By layer:** gov=68, meta=24, ops=33, repository=4, skill=92, tool=105
- **By effective priority:** critical=1, high=2, medium=317, unknown=6
...
- **Work Areas:** delivery=0, documentation=1, methodology=1, project-control=254, skills=34, tests=35, toolchain=32
