...
- **Source digest:** `cf73997cc4383627bc18522d853896d2ea56fb3fd27be905f09e628e267bf2a4`
...
- **Governed artifacts:** 584
- **By role:** atomic=110, derived_or_navigation=84, evergreen=167, implementation=169, transactional=54
- **By type:** analysis_report=23, atomic_record=110, derived_view=1, evidence_record=42, implementation=169, navigation=52, plan=41, procedure=22, specification=95, verification=8, version=21
...
- **By layer:** gov=111, meta=36, ops=45, repository=27, skill=224, tool=141
- **By effective priority:** critical=24, high=48, medium=506, unknown=6
- **By status:** absorbed=22, accepted=38, open=19, resolved=39

## Semantic inventory

- **Semantic claims:** 310
- **By Type:** decision=118, problem=39, qa=134, question=19
- **By direct subtype:** conflict=1, contract=6, defect=19, evaluation=51, gap=4, invariant=1, opportunity=3, requirement=81, test=83
- **Native immutable atoms:** 84
- **Compatibility-classified legacy IDs:** 226

## Typed relation inventory

- **Forward relations:** 427
- **By type:** analysis_of=1, check_of=23, child_of=45, evidence_for=19, implementation_of=288, projection_of=6, relates_to=19, replacement_of=21, resolution_of=5
- **By origin:** authored=108, commit_trailer=288, legacy_child_of=31
- **By source kind:** artifact=139, commit=288
...
- **Work Areas:** delivery=5, documentation=8, methodology=10, project-control=480, skills=36, tests=43, toolchain=44
