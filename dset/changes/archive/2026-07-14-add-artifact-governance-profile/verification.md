...
- **Status:** dated archive candidate; final pushed-head checks and evidence remain; PR stays draft
...
| Reconciliation/archive | Accepted-truth audit, guarded dry-run, and dated move | Candidate move pass; final pushed-head evidence pending | This file and upcoming archive evidence |
