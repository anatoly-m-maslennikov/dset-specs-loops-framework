...
| MDSHAST-REQ/TEST/EVAL-017–018/009–010 | Main-session inheritance, proportional fan-out, explicit deviations, and expected-outcome-cost budgeting | Specification drafted; implementation/runtime eval pending | [Delta specification](specs/methodology.md), [test plan](test-plan.md), and [eval plan](eval-plan.md) |
| MDSHAST-REQ/TEST-019, EVAL-011 | Problems/opportunities/questions intake and external-tracker separation | Specification drafted; routing fixtures pending | [Work-item rules](../../governance/work-items.md) and [delta specification](specs/methodology.md) |
