...
|---|---|
| `00` | Pipeline and routing map |
| `01` | Spec authoring |
| `02` | Separate test-plan and eval-plan authoring |
| `03` | Implementation planning and rollout |
| `04` | General code/runtime pattern catalog and applicability |
| `05` | Language-neutral enforcement and applied profiles |
