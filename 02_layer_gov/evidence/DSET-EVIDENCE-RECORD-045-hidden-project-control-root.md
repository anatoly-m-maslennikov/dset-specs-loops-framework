...
context = ["candidate_commit=fa07cd2ecef6b93474a9b7f0909a9e74f8adc56a", "platform=macos", "python=3.14.6", "tests=323", "ruff_files=90", "mypy_files=89", "schema=1.3"]
observed_at = "2026-07-22T07:16:45+04:00"
evidence_location = ".dset/gov/evidence/DSET-EVIDENCE-RECORD-045-hidden-project-control-root.md"
polarity = "supports"
currentness = "current"
